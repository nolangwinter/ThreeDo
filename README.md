...
ToDo Mobile app that allows you to create tasks, edit tasks and complete tasks.
...
1. Clone the repo
   ```sh
   git clone https://github.com/nolangwinter/ThreeDo.git
   ```
...
Project Link: [https://github.com/nolangwinter/ThreeDo](https://github.com/nolangwinter/ThreeDo)
